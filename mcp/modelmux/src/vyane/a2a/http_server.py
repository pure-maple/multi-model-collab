...
allowing any A2A-compatible client to interact with Vyane agents.
"""
...
from vyane.a2a.patterns import list_patterns
...
logger = logging.getLogger("vyane.a2a.http")
...
class A2AServer:
    """A2A HTTP Server wrapping the Vyane collaboration engine."""
