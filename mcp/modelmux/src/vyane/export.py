...
Usage:
    vyane export --format csv --hours 24
    vyane export --format json --provider codex
    vyane export --format md --hours 168 --output report.md
"""
...
def export_markdown(
    entries: list[dict], stats: dict | None = None, title: str = "Vyane Report"
) -> str:
