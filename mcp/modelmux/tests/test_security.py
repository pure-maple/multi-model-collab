...
class TestPushUrlValidation:
    ...
    def test_https_allowed(self):
        from vyane.a2a.http_server import _validate_push_url
...
class TestExtraArgsSanitization:
    ...
    def test_flag_injection_blocked(self):
        from vyane.adapters.base import sanitize_extra_args
...
class TestA2APolicyEnforcement:
    ...
    def test_check_provider_policy_allows_valid(self):
        ...
        from vyane.policy import Policy

        server = A2AServer(get_adapter=lambda x: None)
        with patch("vyane.a2a.http_server.load_policy", return_value=Policy()):
...
class TestGenericAdapterTemplateInjection:
    ...
    def test_task_key_protected(self):
        from vyane.adapters.generic import GenericAdapter
...
class TestDashScopeBaseUrlSsrf:
    ...
    async def test_extra_args_base_url_ignored(self):
        ...
        with patch.object(adapter, "_get_api_key", return_value="sk-test"), \
             patch("vyane.adapters.dashscope.httpx.AsyncClient") as mock_cls:
...
class TestPromptInjectionDetection:
    ...
    def test_ignore_previous_instructions(self):
        from vyane.security import scan_task
...
class TestPolicyOverrides:
    ...
    def test_default_severity_applies(self):
        ...
        from vyane.security import ThreatLevel, parse_security_policy
...
class TestSecurityAuditLogging:
    ...
    def test_log_security_event(self, tmp_path):
        ...
        with patch("vyane.audit._audit_dir", return_value=tmp_path), \
             patch("vyane.audit._audit_file", return_value=audit_file):
...
class TestSecurityPolicyInPolicy:
    ...
    def test_parse_policy_with_security(self):
        from vyane.policy import _parse_policy
...
class TestDispatchSecurityIntegration:
    ...
    async def test_dispatch_blocks_injection(self):
        ...
        with patch("vyane.server.load_config") as mock_cfg, \
             ...
             patch("vyane.audit.log_security_event"):

            from vyane.config import MuxConfig
            from vyane.detect import CallerInfo
            from vyane.policy import Policy, PolicyResult
